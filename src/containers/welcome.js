          ...
          <div className="container " >
            ...
            >
              <div className="col-md-7">
                ...
                <Link className="btn btn-danger" to={Path.signup}>
            ...
            <div className="col-md-6 row-padding">
              ...
              <div className="works-div">
                ...
                <div>
                  <h2>
                    {" "}
                    <Translator text="welBlock2R6.1" />
                  </h2>
                  <p>
                    {" "}
                    <Translator text="welBlock2R7.1" />
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row h-100 row-padding">
              <div className="col-md-3 my-auto btn-white slider-btn">
                <div>
                  <button
                    className="btn"
                    style={this.state.count === 0 ? style : style1}
                  ...
                  >
                    <Translator text="welBlock3L1R.1" />
                  </button>
                </div>

                <div>
                  <button
                    style={this.state.count === 1 ? style : style1}
                    className="btn"
                    onClick={this.imgChange(
                      arrFeature[1][0],
                      arrFeature[1][1],
                  ...
                  >
                    <Translator text="welBlock3L2R.1" />
                  </button>
                </div>
                <div>
                  <button
                    style={this.state.count === 2 ? style : style1}
                    className="btn"
                    onClick={this.imgChange(
                      arrFeature[2][0],
                      arrFeature[2][1],
                  ...
                  >
                    <Translator text="welBlock3L3R.1" />
                  </button>
                </div>
              </div>
        ...
        <div className="container footer-no-margin">
          ...
          <div className="row txt-img-mob-center">
            ...
            <div className="col-md-4 search-div">
              <h3 className="mt-5">
                <Translator text="welBlock4R2.1" />
              </h3>
              <p>
                <Translator text="welBlock4R3.1" />
              </p>
              ...
              <h3>
                <Translator text="welBlock4R5.1" />
              </h3>
              <p>
                <Translator text="welBlock4R6.1" />
              </p>
            </div>
            <div
