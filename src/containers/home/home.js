                 ...
                 ( update===true)?
                  ...
                  <div className='row home-about-margin ' >
                    <div className='col-md-3 text-left'>
                      ...
                      <p className='f-s-13'>{this.state.comEndData!==null?this.state.comEndData!==undefined?this.state.comEndData['Global Quote']['02. open']!==undefined?this.state.comEndData['Global Quote']['02. open']!==null?parseFloat(this.state.comEndData['Global Quote']['02. open']).toFixed(2) :null:null:null:null}</p>
                    ...
                    <div className='col-md-3 text-left'>
                      <div className=' '>
                          ...
                          <p className='f-s-13'>  {this.state.comEndData!==null?this.state.comEndData!==undefined?this.state.comEndData['Global Quote']['03. high']!==undefined?this.state.comEndData['Global Quote']['03. high']!==null?parseFloat(this.state.comEndData['Global Quote']['03. high']).toFixed(2) :null:null:null:null}</p>
                    ...
                    <div className='col-md-3 text-left'>
                      <div className=' '>
                          ...
                          <p className='f-s-13'>{this.state.comEndData!==null?this.state.comEndData!==undefined?this.state.comEndData['Global Quote']['04. low']!==undefined?this.state.comEndData['Global Quote']['04. low']!==null?parseFloat(this.state.comEndData['Global Quote']['04. low']).toFixed(2) :null:null:null:null}</p>
                      </div>
