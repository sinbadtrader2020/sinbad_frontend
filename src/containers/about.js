              ...
              <div className="container ">
                ...
                >
                  <div className="col-md-7">
                    ...
                    <p>
                      Sinbad Finance is a stock screening tool designed for
                      making ethical invesment easier. Now you can know which
                      stock is ethical and which one is not. Whether you are
                      looking to invest ethical or you would like to check if
                      your current invesment is ethical, Sinbad Finance is here
                      to help.
                    </p>
                  </div>
              ...
              <div className="m-auto faq-support-card faq-about-card">
                <div className="row justify-content-md-around faq-div-support-margin text-center ">
                  ...
                  <div className="col-md-4">
                    ...
                    <h2>Lower Fees</h2>
                    <p>
                      Monitor performance and view your holdings at any time.
                    </p>
                  </div>
                </div>
                ...
                <div className="row" style={{ paddingBottom: "50px" }}>
                  <div className="row-padding ">
                    ...
                    <div className="row div-row-work-padding">
                      ...
                      >
                        <img className='img-screen-size' src={"assets/images/work1.png"} alt="logo" />
                      </div>
                      ...
                      <div className="col-md-7 m-auto">
                        <div className="works-div ">
                          <h4 className="text-center">
                            Search by company name or ticker and you should find
                            out whether or not your stock is ethical
                          </h4>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row div-row-work-padding">
                      <div className="col-md-7 m-auto">
                        <div className="works-div ">
                          <h4 className="text-center">
                            Get results based on ethical investment method
                            adopted by AAOIFI. More ESG stocks screening
                            methodologies (DowJones, FTSE, Standard & Poors and
                            MSCI) coming soon.
                          </h4>
                        </div>
                      </div>
                      ...
                      <div
                        ...
                        style={{ textAlign: "center" }}
                      >
                        <img className='img-screen-size' src={"assets/images/work2.png"} alt="logo" />
                      </div>
                    </div>
                    {/* 3rd */}
                    <div className="row div-row-work-padding">
                      <div className="col m-auto">
                        <div className="works-div ">
                          <p className="text-center">
                            Don’t have a stock on mind… No problem! Use our
                            advanced search option, to find out ethical stocks
                    ...
                    <div className="row div-row-work-padding">
                      <div
                        ...
                        style={{ textAlign: "center" }}
                      >
                        <img className='img-screen-size' src={"assets/images/work3.png"} alt="logo" />
                      </div>
                      <div className="col-md-1"></div>
              ...
              <div className="m-auto faq-support-card padding-zero">
                <div className="row  justify-content-md-around faq-div-support-margin text-center ">
                  <div className="col-md-3 ">
                    ...
                    <p>
                      Your excess savings don't need to sit in a bank account.
                    </p>
                    <p>
                      Become a ethical investor with Sinbad Finance in minutes
                      by opening an individual account.
                    </p>
                  </div>
                  <div className="col-md-3">
                    <h4>Savings</h4>
            ...
            <div className="container footer-no-margin padding-extra">
              <div className="row div-row-padding">
               ...
               <input type="text" id="inputMDEx" class="form-control"/>
                ...
                <p >By clicking on the 'GET THE APP' button above, you confirm that you have entered your own phone number and you consent to receiving the SMS.</p>
